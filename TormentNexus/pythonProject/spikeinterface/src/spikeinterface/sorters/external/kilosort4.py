...
class Kilosort4Sorter(BaseSorter):
    ...
    def is_installed(cls):
        try:
            import spikeinterface.sorters.external.kilosort as ks
            import torch
    ...
    def _run_from_folder(cls, sorter_output_folder, params, verbose):
        from spikeinterface.sorters.external.kilosort import (
            set_files,
            initialize_ops,
        ...
        from spikeinterface.sorters.external.kilosort import load_probe, RecordingExtractorAsArray, BinaryFiltered, save_preprocessing
        from spikeinterface.sorters.external.kilosort import DEFAULT_SETTINGS
